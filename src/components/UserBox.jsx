...
/></div>
        <div className="right">
            <h2 className="text-black font-['Poppins'] text-lg font-medium leading-[normal]">Mr. Shlok Admin <span className="  inline-flex flex-shrink-0 justify-center items-center pt-[0.1875rem] pb-[0.1875rem] pl-[0.3125rem] pr-[0.4375rem] h-[1.375rem] rounded-md border-[1.08px] border-[#007aff]  text-[#007aff] font-['Poppins'] text-sm leading-[125%]">New</span></h2>
    ...
    <div className="right flex items-center">
       ...
       {/* <DeleteDialog handleClickOpen={handleClickOpen} open={open} setOpen={setOpen} handleClose={handleClose}/>  */}
       <DeleteIcon/>
